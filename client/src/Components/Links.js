...
class Links extends Component {
  ...
  render() {
    return (<footer className="row justify-content-left bg-primary fixed-bottom text-center text-md-left">
      <div className="col col-md-3">
        ...
        <a href="https://venmo.com/Peyton-Sonnefeld"><i className="fas fa-heartbeat"></i></a>
      </div>
    </footer>)
  }
}
