    ...
    return (
      <div className="col col-md-4 text-center">
        <div className="stat-size">
          ...
          {opponent.name && <p className={opponent.uairAutoCancel === player.uairAutoCancel ? "text-yellow border-yellow" : opponent.uairAutoCancel > player.uairAutoCancel ? "text-green border-green" : "text-danger border-danger"}>{opponent.uairAutoCancel}</p>}
          ...
          {opponent.name && <p className={opponent.fairAutoCancel === player.fairAutoCancel ? "text-yellow border-yellow" : opponent.fairAutoCancel > player.fairAutoCancel ? "text-green border-green" : "text-danger border-danger"}>{opponent.fairAutoCancel}</p>}
