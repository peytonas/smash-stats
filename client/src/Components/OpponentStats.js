    ...
    return (
      <div className="col col-md-4 text-center">
        <div className="stat-size">
          ...
          {opponent.name && <p className={opponent.upTiltStartup === player.upTiltStartup ? "text-yellow border-yellow" : opponent.upTiltStartup < player.upTiltStartup ? "text-green border-green" : "text-danger border-danger"}>{opponent.upTiltStartup}</p>}

          {opponent.name && <p className={opponent.upTiltLag === player.upTiltLag ? "text-yellow border-yellow" : opponent.upTiltLag < player.upTiltLag ? "text-green border-green" : "text-danger border-danger"}>{opponent.upTiltLag}</p>}
          ...
          {opponent.name && <p className={opponent.downTiltStartup === player.downTiltStartup ? "text-yellow border-yellow" : opponent.downTiltStartup < player.downTiltStartup ? "text-green border-green" : "text-danger border-danger"}>{opponent.downTiltStartup}</p>}
          ...
          {opponent.name && <p className={opponent.upSmashStartup === player.upSmashStartup ? "text-yellow border-yellow" : opponent.upSmashStartup < player.upSmashStartup ? "text-green border-green" : "text-danger border-danger"}>{opponent.upSmashStartup}</p>}

          {opponent.name && <p className={opponent.upSmashLag === player.upSmashLag ? "text-yellow border-yellow" : opponent.upSmashLag < player.upSmashLag ? "text-green border-green" : "text-danger border-danger"}>{opponent.upSmashLag}</p>}
          ...
          {opponent.name && <p className={opponent.downSmashStartup === player.downSmashStartup ? "text-yellow border-yellow" : opponent.downSmashStartup < player.downSmashStartup ? "text-green border-green" : "text-danger border-danger"}>{opponent.downSmashStartup}</p>}
          ...
          {opponent.name && <p className={opponent.grabStartup === player.grabStartup ? "text-yellow border-yellow" : opponent.grabStartup < player.grabStartup ? "text-green border-green" : "text-danger border-danger"}>{opponent.grabStartup}</p>}

          {opponent.name && <p className={opponent.grabLag === player.grabLag ? "text-yellow border-yellow" : opponent.grabLag < player.grabLag ? "text-green border-green" : "text-danger border-danger"}>{opponent.grabLag}</p>}

          {opponent.name && <p className={opponent.dashGrabStartup === player.dashGrabStartup ? "text-yellow border-yellow" : opponent.dashGrabStartup < player.dashGrabStartup ? "text-green border-green" : "text-danger border-danger"}>{opponent.dashGrabStartup}</p>}
          ...
          {opponent.name && <p className={opponent.forwardThrowStartup === player.forwardThrowStartup ? "text-yellow border-yellow" : opponent.forwardThrowStartup < player.forwardThrowStartup ? "text-green border-green" : "text-danger border-danger"}>{opponent.forwardThrowStartup}</p>}

          {opponent.name && <p className={opponent.forwardThrowLag === player.forwardThrowLag ? "text-yellow border-yellow" : opponent.forwardThrowLag < player.forwardThrowLag ? "text-green border-green" : "text-danger border-danger"}>{opponent.forwardThrowLag}</p>}
          ...
          {opponent.name && <p className={opponent.backThrowStartup === player.backThrowStartup ? "text-yellow border-yellow" : opponent.backThrowStartup < player.backThrowStartup ? "text-green border-green" : "text-danger border-danger"}>{opponent.backThrowStartup}</p>}

          {opponent.name && <p className={opponent.backThrowLag === player.backThrowLag ? "text-yellow border-yellow" : opponent.backThrowLag < player.backThrowLag ? "text-green border-green" : "text-danger border-danger"}>{opponent.backThrowLag}</p>}
          ...
          {opponent.name && <p className={opponent.upThrowStartup === player.upThrowStartup ? "text-yellow border-yellow" : opponent.upThrowStartup < player.upThrowStartup ? "text-green border-green" : "text-danger border-danger"}>{opponent.upThrowStartup}</p>}

          {opponent.name && <p className={opponent.upThrowLag === player.upThrowLag ? "text-yellow border-yellow" : opponent.upThrowLag < player.upThrowLag ? "text-green border-green" : "text-danger border-danger"}>{opponent.upThrowLag}</p>}
          ...
          {opponent.name && <p className={opponent.downThrowStartup === player.downThrowStartup ? "text-yellow border-yellow" : opponent.downThrowStartup < player.downThrowStartup ? "text-green border-green" : "text-danger border-danger"}>{opponent.downThrowStartup}</p>}

          {opponent.name && <p className={opponent.downThrowLag === player.downThrowLag ? "text-yellow border-yellow" : opponent.downThrowLag < player.downThrowLag ? "text-green border-green" : "text-danger border-danger"}>{opponent.downThrowLag}</p>}
          ...
          {opponent.name === "Terry" && <p className={opponent.name === player.name ? "text-yellow border-yellow" : "text-green border-green"}>{opponent.superSpecial1}</p>}

          {opponent.name === "Terry" && <p className={opponent.name === player.name ? "text-yellow border-yellow" : "text-green border-green"}>{opponent.superSpecial1Startup}</p>}

          {opponent.name === "Terry" && <p className={opponent.name === player.name ? "text-yellow border-yellow" : "text-green border-green"}>{opponent.superSpecial1Lag}</p>}

          {opponent.name === "Terry" && <p className={opponent.name === player.name ? "text-yellow border-yellow" : "text-green border-green"}>{opponent.superSpecial2}</p>}

          {opponent.name === "Terry" && <p className={opponent.name === player.name ? "text-yellow border-yellow" : "text-green border-green"}>{opponent.superSpecial2Startup}</p>}

          {opponent.name === "Terry" && <p className={opponent.name === player.name ? "text-yellow border-yellow" : "text-green border-green"}>{opponent.superSpecial2Lag}</p>}
        </div>
      </div>
    )
  }
